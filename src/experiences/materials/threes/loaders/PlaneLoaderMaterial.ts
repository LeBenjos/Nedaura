...
export default class PlaneLoaderMaterial extends ShaderMaterial {
    ...
    constructor() {
        super({
            transparent: true,
            uniforms: {
                uAlpha: { value: PlaneLoaderMaterial._DEFAULT_UNIFORMS_ALPHA },
                uColor: { value: new Color(PlaneLoaderMaterial._DEFAULT_UNIFORMS_COLOR) },
            },
    ...
    public async show(): Promise<void> {
        ...
        await gsap.to(this.uniforms.uAlpha, {
            value: 1,
            duration: PlaneLoaderMaterial._GSAP_DURATION_FADE_IN,
